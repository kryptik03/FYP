"""
backbone_exp04_dec.py
=====================
1D CNN Backbone for Deep Embedded Clustering (exp04).
...
The cluster assignment head (soft-Q) lives in DECTask, not here.
This keeps the backbone reusable for feature extraction and HDBSCAN inference.
"""
