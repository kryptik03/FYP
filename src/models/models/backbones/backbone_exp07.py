...
class DECCNN2D_Exp07(nn.Module):
    """
    Lightweight 2D CNN designed to process (1, Freq, Time) STFT magnitude spectrograms.
    Extracts features for both SupCon contrastive learning and DEC clustering.
    """
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # L2 Normalize for DEC and Contrastive learning stability
