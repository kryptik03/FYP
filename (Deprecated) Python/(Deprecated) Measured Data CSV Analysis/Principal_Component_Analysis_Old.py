...
def perform_pca_and_visualize(input_csv='Wavelet_Features.csv'):
    # 1. Load Data
    # We only read the necessary columns. 
    # The paper uses all 6 energy levels as input.
    print(f"Loading data from {input_csv}...")
    
    if not os.path.exists(input_csv):
        print(f"Error: {input_csv} not found. Please run the decomposition script first.")
        return
    ...
    # The paper defines the input Matrix M as N vectors of 6 dimensions 
    ...
    # The paper aims to reduce dimensionality to 3-D space [cite: 116]
    # while "minimizing lost information"[cite: 19].
